            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // Okay I know the lambda here violates core guideline F.7
                        // This is because the lambda takes a reference to a std::unique_ptr but it does not affect ownership.
                        // I don't see an elegant way around this violation.
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // Again, these lambdas violate core guideline F.7. I don't see an elegant way around this violation.
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // don't use edge after this line!
                        }
